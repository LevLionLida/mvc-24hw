...
trait Queryable
{
    ...
    public function where(string $column, $condition, string $value)
    {
...
//        }
    ...
    public static function findIn(string $arg): array
    {
        $arrFind = Category::select([$arg])->get();
        $arrFindVal = [];
        foreach ($arrFind as $value) {
            $arrFindVal[] = $value->title;
        }
        return $arrFindVal;
    }
